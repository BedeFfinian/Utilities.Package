...
# Utilities.Package <img src="man/figures/logo.png" width="200px" height="200px" align="right" style="padding-left:10px;background-color:white;" />

Primarily, Utilities.Package is a package of simple utility features for data manipulation and simple statistics. It also contains personalisable palettes and themes for ggplot2 plots. Plus, any random crap that Molly adds.
...
devtools::install_github("MBERC/Utilities.Package")
```
...
```{r colour use,message=FALSE,fig.width=15}
...
colourplot6<-ggplot(data = df2, aes(x = flipper_length_mm, y = body_mass_g)) +
  ...
  labs(x="Flipper Length (mm)",
       y="Body Mass (g)",
       color="Bathy_Blues Bede",
       title="Bathy_Blues Palette from Bede")+
  Utilities.Package::theme_Bede()+
